...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">User /</span> Edit</h4>
                 ...
                 <div class="dt-action-buttons text-end pt-3 pt-md-0">
                    <div class="dt-buttons">
                        <a href="{{ route('user.list') }}" class="dt-button create-new btn btn-primary btn-sm" >
                            <span class="tf-icon mdi mdi-eye me-1"></span>User List</a>
                    </div>
                </div>
                <div class="card-body">
				  ...
				  <div class="row gy-4 gy-md-0">
                    ...
                    <form method="POST" action="{{ route('user.update') }}">
						...
						<div class="form-floating form-floating-outline mb-4">
								...
								<div class="form-floating form-floating-outline mb-4">
                                    <input type="date" name="dob" required id="html5-date-input" class="form-control" placeholder="DOB" aria-label="DOB" value = "{{ $user->dob }}" />
                                ...
                                <div class="form-floating form-floating-outline mb-4">
                                    <select id="collapsible-role" class="select2 form-select" name="role" required>
                                        ...
                                        <option value="Executive" @if($user->role == 'Executive') selected @endif>Executive</option>
                                    </select>
