...
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Country /</span> Update</h4>
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="card border shadow-none h-100">
                                ...
                                <div class="card-header header-elements">
                                    <h5 class="me-2">Update Country</h5>
  ...
  <div class="row">
                    ...
                    <form class="pt-0" method = "post" action = "{{ route('country.update') }}" enctype="multipart/form-data">
                      <!-- Currency Name-->
                      {{ csrf_field() }}
                      ...
                      <img src = "{{ url('/').Storage::url('/').$country->country_flag }}" style="width: 100px;" />
                      <input type="hidden" name = "oldimage" value = "{{ $country->country_flag }}">
                      <div class="form-floating form-floating-outline mb-4">
                          <input type="file" 
                       ...
                       <div class="form-floating form-floating-outline mb-4">
                        <select
                              ...
                              @php 
                                ...
                                $value =  ($country->currency_id == $cur->id) ? 'Selected' : '';  

                              @endphp

                               <option value="{{ $cur->id }}" {{ $value }} >{{ $cur->currency_name }}</option> 
                              @endforeach                         
                            </select>
