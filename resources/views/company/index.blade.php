...
<h4 class="py-3 mb-4"><span class="text-muted fw-light">Tenant /</span> List</h4>
        ...
        <section class="section-py">
            <div class="container">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="card border shadow-none h-100">
                                ...
                                <div class="card-header header-elements">
                                    <h5 class="me-2">Tenant List</h5>

                                      <div class="card-header-elements ms-auto">
                                        <a href="{{ route('tenant.create') }}" class="btn btn-primary waves-effect waves-light">
                                          <span class="tf-icon mdi mdi-plus me-1"></span>Add Tenant
                                        </a>
                                      </div>
                                    </div>
                ...
                <a href="{{ url('/tenant/'.$ten->id.'/edit') }}" class="btn-warning btn" title="Edit"><i class="fa fa-pencil action_icon"></i>
                </a>
...
@endsection
<input type="hidden" name="redirecturl" id="redirecturl" value="{{ url('/tenant/') }}">  
