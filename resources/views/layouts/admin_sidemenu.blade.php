    ...
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            ...
            <ul class="menu-inner py-1 ps ps--active-y">
                ...
                <!-- Users -->
                <li
                    class="menu-item {{ (request()->segment(2) == 'user') ? 'active' : '' }}">
                ...
                <li
                    ...
                    <ul class="menu-sub">
                    <li class="menu-item">
                      <a href="{{ route('currency.list') }}" class="menu-link">
                    ...
                    <li class="menu-item">
                      <a href="{{ route('state.list') }}" class="menu-link" >
                        <div data-i18n="State">State</div>
                      </a>
                    </li>
                    <li class="menu-item">
                      <a href="{{ route('denomination.list') }}" class="menu-link" >
