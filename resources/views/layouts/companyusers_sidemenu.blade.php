<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" data-bg-class="bg-menu-theme" style="touch-action: none; user-select: none; -webkit-user-drag: none; -webkit-tap-highlight-color: rgba(0, 0, 0, 0); background-color: #173953 !important;color:#d1d1e7;">
            ...
            <ul class="menu-inner py-1 ps ps--active-y">
                ...
                <li
                 ...
                 <li
                    ...
                    <a href="{{ route('companyusers.profile') }}" class="menu-link">
