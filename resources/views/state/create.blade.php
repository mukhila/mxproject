...
<h4 class="py-3 mb-4"><span class="text-muted fw-light">State /</span> Add</h4>
  ...
  <div class="row">
                    ...
                    <form class="pt-0" method = "post" action = "{{ route('state.save') }}">
                      <!-- State Name-->
                      {{ csrf_field() }}
                       ...
                       <div class="form-floating form-floating-outline mb-4">
                        <select
                              ...
                              @foreach($country as $cur)
                               <option value="{{ $cur->id }}">{{ $cur->country_name }}</option> 
                              @endforeach                         
                            </select>
